(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('omi')) :
  typeof define === 'function' && define.amd ? define(['exports', 'omi'], factory) :
  (factory((global.omiI18n = global.omiI18n || {}),global.omi));
}(this, (function (exports,omi) { 'use strict';
...
var t$1 = i18next$1.t.bind(i18next$1);
...
var FormattedText = function (_WeElement) {
  _inherits$4(FormattedText, _WeElement);

  function FormattedText() {
    _classCallCheck$9(this, FormattedText);

    return _possibleConstructorReturn$4(this, (FormattedText.__proto__ || Object.getPrototypeOf(FormattedText)).apply(this, arguments));
  }
  ...
  _createClass(FormattedText, [{
    ...
    value: function installed() {
      if (this.props.sethtml) this.host.innerHTML = i18next$1.t(this.props.key, this.props.options);
    }
  }, {
    key: "render",
    value: function render(props, data) {
      var ele = props.ele,
          ...
          css = props.css,
          rest = _objectWithoutProperties(props, ["ele", "key", "options", "sethtml", "css"]);

      return omi.h(ele || 'span', rest, sethtml ? undefined : i18next$1.t(key, options));
    }
  }]);
...
FormattedText.pure = true;


omi.define('i18n-text', FormattedText);
...
var I18nProvider = function (_WeElement) {
  _inherits$5(I18nProvider, _WeElement);

  function I18nProvider() {
    _classCallCheck$10(this, I18nProvider);

    return _possibleConstructorReturn$5(this, (I18nProvider.__proto__ || Object.getPrototypeOf(I18nProvider)).apply(this, arguments));
  }

  _createClass$1(I18nProvider, [{
    key: "install",
    value: function install() {
      ...
      if (i18next$1.isInitialized) return;
      ...
      i18next$1.init({
        ...
        if (_this2.parentNode && _this2.parentNode.host) {
          _this2.parentNode.host.update && _this2.parentNode.host.update();
          handleRecursiveUpdate(_this2);
        } else {
          _this2.parentNode.update && _this2.parentNode.update();
          handleRecursiveUpdate(_this2);
        }
      });
    }
    ...
    value: function render(props) {
      if (!this.data.ready) {
        return Omi.h("slot", { name: "loading" });
      }
      return Omi.h("slot", null);
    }
  }], [{
    key: "data",
    get: function get() {
...
I18nProvider.pure = true;


omi.define('i18n-provider', I18nProvider);
